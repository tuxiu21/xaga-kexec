...
AK_COMMON_BASE="${AK_COMMON_BASE:-$AK/common}"
AK_COMMON_STOCK="${AK_COMMON_STOCK:-$AK/common-stock}"
AK_COMMON_UBUNTU="${AK_COMMON_UBUNTU:-$AK/common-ubuntu}"
KERNEL_STOCK_OUT="${KERNEL_STOCK_OUT:-$AK/out-stock/android12-5.10/common}"
KERNEL_STOCK_DIST="${KERNEL_STOCK_DIST:-$AK/out-stock/android12-5.10/dist}"
KERNEL_UBUNTU_OUT="${KERNEL_UBUNTU_OUT:-$AK/out-ubuntu/android12-5.10/common}"
KERNEL_UBUNTU_DIST="${KERNEL_UBUNTU_DIST:-$AK/out-ubuntu/android12-5.10/dist}"
...
DIAG_ROOT="${DIAG_ROOT:-$WORK_DIR/diagnostics}"
BACKUP_ROOT="${BACKUP_ROOT:-$WORK_DIR/backups}"
...
mkdir -p "$LOG_ROOT" "$DIAG_ROOT" "$BACKUP_ROOT" "$OUTPUT_DIR" "$VENDOR_DIR" "$TMP_ROOT"
